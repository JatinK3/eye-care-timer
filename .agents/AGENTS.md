...
* Adhere to Conventional Commits specifications (e.g., using prefixes like `feat:`, `fix:`, `docs:`, `chore:`, `refactor:`) and maintain semver Git tags (e.g., `v1.0.0`) for every release, enabling clean changelog generation from tag differences.
