...
- `lib/models/timer_settings.dart`: Persisted timer settings model and defaults, including notification and feedback preferences.
...
- `lib/services/preferences_service.dart`: `shared_preferences` load/save for durations, theme mode, color preset, daily streak, notification preference, feedback preferences, and active timer session.
...
- Theme mode, color preset, work duration, break duration, daily streak, notification preference, haptic/sound preferences, and active timer session are persisted.
